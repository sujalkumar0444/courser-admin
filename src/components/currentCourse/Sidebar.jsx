...
function NavItemslist(props){
  ...
  >
    ...
    <span className="flex-1 ms-3 whitespace-nowrap">{props.prop.module_title}</span>
...
function Sidebar() {
  let Modulesdata=useSelector((state)=>state.CurrentCourse.currentCoursedata.modules)
